...
export default function Services() {
    ...
    return (
        <section id="our-services" className="py-24 bg-white relative">
            <div className="container mx-auto px-6 lg:px-12">
                ...
                <div className="text-center mb-20 max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {specializedServices.map((service, idx) => (
                            <div
                                key={idx}
                                className="group flex flex-col bg-bg-light rounded-2xl overflow-hidden shadow-sm hover:shadow-[0_8px_30px_rgb(0,8,44,0.15)] transition-all duration-300 border border-transparent hover:border-primary/20 hover:-translate-y-2"
                            >
                ...
                {/* Unified Services & Products Section */}
